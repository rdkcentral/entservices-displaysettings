...
- Return resolution list from EDID data for external displays or platform capabilities for built-in displays
...
- `supported-resolutions-query`: Ability to retrieve the list of supported display resolutions from EDID or platform capabilities, with support for multiple video display ports
...
- **Dependencies**: Relies on Display Manager (DS) HAL for EDID parsing and resolution data

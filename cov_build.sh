...
############################
# Build entservices-displaysettings
echo "buliding entservices-displaysettings"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-displaysettings \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-displaysettings --target install
echo "======================================================================================"
exit 0
